        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <span style="background: #667eea; color: white; padding: 5px 10px; border-radius: 20px; font-weight: 600;">
      ...
      <div class="booking-form">
        ...
        <form action="resvn.php" method="post">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group-custom">
                <label><i class="fas fa-train"></i> Train No *</label>
                <input type="text" name="tno" placeholder="E.g., T001" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group-custom">
                <label><i class="fas fa-layer-group"></i> Class *</label>
                <input type="text" name="class" placeholder="E.g., AC 1 Tier" required>
              </div>
            </div>
          </div>
          ...
          <div class="form-group-custom">
            ...
            <input type="number" name="nos" min="1" max="10" placeholder="Enter number of seats" required>
          </div>
